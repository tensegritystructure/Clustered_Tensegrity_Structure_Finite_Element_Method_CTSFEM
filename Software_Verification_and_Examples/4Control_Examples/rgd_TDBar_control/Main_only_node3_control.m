...
for  i = 1:1/dt
   j = 100;
    ...
    x_tem = 1+(n_tar/2-1)*j*dt; y_tem = sqrt(2 - x_tem^2);
...
L = [1 0 0;0 1 0;0 0 0]; 
R = zeros(length(N_new(1,:)),length(control_point));
R(3) = 1;
...
Nd = 0*N; x0 = [N*U2 , Nd*U2]; dt = 0.001; tf =2;
t = 0:dt:tf;
a=2.5; b=4;
Inp.Yt = N_cell; 
% Inp.Yt = [2.6 0 0]';

Inp.a=a;Inp.b=b;Inp.Cs = Cs; Inp.Cb=Cb; Inp.W=W; Inp.s0=s0;
