...
beta=30*pi/180;
[N,C] =generat_wheel_type_cable_truss(R,p,h,beta);
...
pinned_X=([3:3:36])'; pinned_Y=([3:3:36])'; pinned_Z=([3:3:36])';
[Ia,Ib,a,b]=tenseg_boundary(pinned_X,pinned_Y,pinned_Z,nn);

%% Group/Clustered information 
%generate group index
% gr=[];
% gr={[1:7:78]};     % clustering bars
% gr={[2:7:79,3:7:73]};     % clustering ridge strings
% gr={[2:7:79,3:7:73];[4:7:81,5:7:82]};     % clustering ridge strings,diagonal strings
% gr={[2:7:79,3:7:73];[4:7:81,5:7:82];[6:7:83]};     % clustering ridge strings,diagonal strings, bottom strings
gr={[1:7:78];[2:7:79,3:7:73];[4:7:81,5:7:82];[6:7:83];[7:7:84]};     % clustering ridge strings,diagonal strings, bottom strings, top strins
gr2={[2:7:79,3:7:73];[7:7:84]};     % clustering ridge strings,top strins
Gp=tenseg_str_gp(gr,C);    %generate group matrix
Gp2=tenseg_str_gp(gr2,C);    %generate group matrix
