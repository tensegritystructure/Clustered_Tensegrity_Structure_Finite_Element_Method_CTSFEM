...
tenseg_plot_result(1:substep,n_t([[9:12]'*3-1],:),{'12Y'},{'Substep','Coordinate (m)'},'plot_coordinate.png',saveimg);
grid on
...
%% save data
if savedata==1
    save (['prism_static_elasto_plastic','.mat']);
end
...
%% Plot nodal coordinate curve X Y
tenseg_plot_result(out_tspan,n_t([[12]'*3-1],:),{'12Y'},{'Time (s)','Coordinate (m)'},'plot_coordinate.png',saveimg);
...
%% save output data
if savedata==1
    save (['prism_dynamic_',num2str(tf),material{1},'.mat'],'n_t');
end
