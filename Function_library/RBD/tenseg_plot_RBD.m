function [fig_out] = tenseg_plot_RBD( N,C_b,C_s,fig_handle,highlight_nodes,view_vec, PlotTitle, R3Ddata,n_qp)
...
%   n_qp: a cell containg the nodal coordinate in a rigid body
% Outputs:
