function data_out = ode4_CTS(odefun,tspan,y0,data_in)
...
global l f n f_int l_int n_d stress strain  exitflag  l0_c
...
for i = 2:N
    ...
    if  sum(out_tspan==ti)
        ...
        data_out.exitflag_t(:,out_tspan==ti)=exitflag; 
...
if  sum(out_tspan==tspan(end))
    ...
    data_out.exitflag_t(:,out_tspan==tspan(end))=exitflag; 
end
