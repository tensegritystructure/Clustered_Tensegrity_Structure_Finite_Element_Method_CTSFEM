function plot_mode2(Mode,value,N,Ia,C_b,C_s,l,title,xlb,ylb,unit,num_plt,ampli,saveimg,view_vec)
...
% with eigenvalue. 
% The unit of eigenvalue is added.
%
switch nargin
    case 13
        view_vec=2;
...
for i=1:numel(num_plt)
    f1=figure;
    title2=(['mode ',num2str(num_plt(i)),': ',num2str(value(num_plt(i)),'%.4f'),unit]);
    %plot buckling mode
